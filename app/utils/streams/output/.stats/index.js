...
(function() {
	...
	var DEST = path.resolve( __dirname, '../../../../../public/data/stats' );
	...
	*/
	function onEnd( name, x, y, clbk ) {
		return function onEnd() {
			console.log( name + ': ' + x + ' of ' + y + ' stats streams finished...' );
			if ( x === y ) {
				clbk();
			}
		};
	...
	*	Takes a directory hash and calculates reductions across all hash datasets. Calculations are performed according to reduction functions.
	*
